...
import { Mail, Phone, MapPin, MessageCircle, Send, Loader2, Sun, Globe } from "lucide-react";
                                ...
                                <Form {...form}>
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 relative z-10">
                                        ...
                                        <Button
                                            ...
                                            type="submit"
                                            className="w-full bg-primary text-black hover:bg-white hover:shadow-[0_0_50px_rgba(255,255,255,0.1)] font-black uppercase tracking-[0.2em] py-10 rounded-full transition-all duration-500 group"
                                        >
                                            {isSubmitting ? (
                                                <>
                        ...
                        <div className="lg:col-span-5 space-y-12">
                            ...
                            >
                                <div className="relative z-10 text-center">
                                    ...
                                    <Button variant="outline" className="w-full border-[#0A0E1A] text-[#0A0E1A] hover:bg-[#0A0E1A] hover:text-white font-black uppercase tracking-widest rounded-full h-16 transition-all duration-500" asChild>
                                        <a href="https://wa.me/254718790654" target="_blank" rel="noopener noreferrer">Initiate WhatsApp Chat</a>
                                    </Button>
                                </div>
